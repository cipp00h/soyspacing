...
class CountSpace:
    ...
    def correct(self, doc, min_count=10, force_abs_threshold=0.8,
        ...
        while True :
            ...
            features_list, scores_lcr, scores, is_updated = self.force_tag(
                tags, length, features_list, scores_lcr, scores,
                force_abs_threshold, min_count, num_iter, verbose, is_updated, debug)

            # sequential tagging: find maximum score and its index
            features_list, scores_lcr, scores, is_updated = self.sequential_tag(
                tags, features_list, scores_lcr, scores, nonspace_threshold,
                space_threshold, min_count, num_iter, verbose, is_updated, debug)
    ...
    def force_tag(self, tags, length, features_list, scores_lcr,
        scores, force_abs_threshold, min_count, num_iter,
        verbose, is_updated, debug):
    ...
    def sequential_tag(self, tags, features_list, scores_lcr,
        scores, nonspace_threshold, space_threshold, min_count,
        num_iter, verbose, is_updated, debug):
